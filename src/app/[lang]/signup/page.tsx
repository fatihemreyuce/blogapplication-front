...
export default async function SignupPage({ params }: PageProps<"/[lang]/signup">) {
  ...
  return (
    <section className="relative min-h-[calc(100vh-56px)] overflow-hidden py-10 md:py-16">
      <div className="pointer-events-none absolute -top-20 left-0 h-72 w-72 rounded-full bg-violet-500/10 blur-3xl" />
      <div className="pointer-events-none absolute top-16 right-0 h-72 w-72 rounded-full bg-emerald-500/10 blur-3xl" />
      <div className="mx-auto max-w-6xl px-4">
        <AuthCard3D mode="signup" lang={lang} />
      </div>
    </section>
  );
}
